...
description: This skill encodes Emil Kowalski's philosophy on UI polish, component design, animation decisions, and the invisible details that make software feel great. Use when reviewing UI code, building animations, designing interactive components, or asking about CSS transitions, spring physics, gesture interactions, or performance of visual effects.
---
