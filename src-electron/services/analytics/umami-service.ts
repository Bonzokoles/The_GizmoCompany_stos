...
export class UmamiService {
  ...
  /** Register all IPC handlers — safe to call multiple times (dev reload) */
  registerIPC(): void {
    // Remove existing handlers to prevent "already registered" error on hot-reload
    for (const ch of UmamiService.CHANNELS) {
